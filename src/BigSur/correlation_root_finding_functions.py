...
def find_real_root(coefs, extraprec=False, maxsteps = 20):
    ...
    if extraprec is not False:
        try:
            roots = polyroots([*coefs][::-1], maxsteps=maxsteps, extraprec=extraprec)
